...
bool visit_type_GuestAgentCommandInfo(Visitor *v, const char *name, GuestAgentCommandInfo **obj, Error **errp);
bool visit_type_GuestAgentCommandInfoList(Visitor *v, const char *name, GuestAgentCommandInfoList **obj, Error **errp);

bool visit_type_GuestAgentInfo_members(Visitor *v, GuestAgentInfo *obj, Error **errp);
bool visit_type_GuestAgentInfo(Visitor *v, const char *name, GuestAgentInfo **obj, Error **errp);
...
bool visit_type_GuestFileRead(Visitor *v, const char *name, GuestFileRead **obj, Error **errp);
...
bool visit_type_GuestFileWrite(Visitor *v, const char *name, GuestFileWrite **obj, Error **errp);
...
bool visit_type_GuestFileSeek(Visitor *v, const char *name, GuestFileSeek **obj, Error **errp);
bool visit_type_QGASeek(Visitor *v, const char *name, QGASeek *obj, Error **errp);
bool visit_type_GuestFileWhence(Visitor *v, const char *name, GuestFileWhence **obj, Error **errp);
...
bool visit_type_GuestFsfreezeStatus(Visitor *v, const char *name, GuestFsfreezeStatus *obj, Error **errp);
...
bool visit_type_GuestFilesystemTrimResult(Visitor *v, const char *name, GuestFilesystemTrimResult **obj, Error **errp);
bool visit_type_GuestFilesystemTrimResultList(Visitor *v, const char *name, GuestFilesystemTrimResultList **obj, Error **errp);

bool visit_type_GuestFilesystemTrimResponse_members(Visitor *v, GuestFilesystemTrimResponse *obj, Error **errp);
bool visit_type_GuestFilesystemTrimResponse(Visitor *v, const char *name, GuestFilesystemTrimResponse **obj, Error **errp);

bool visit_type_q_obj_guest_fstrim_arg_members(Visitor *v, q_obj_guest_fstrim_arg *obj, Error **errp);
bool visit_type_GuestIpAddressType(Visitor *v, const char *name, GuestIpAddressType *obj, Error **errp);

bool visit_type_GuestIpAddress_members(Visitor *v, GuestIpAddress *obj, Error **errp);
bool visit_type_GuestIpAddress(Visitor *v, const char *name, GuestIpAddress **obj, Error **errp);

bool visit_type_GuestNetworkInterfaceStat_members(Visitor *v, GuestNetworkInterfaceStat *obj, Error **errp);
bool visit_type_GuestNetworkInterfaceStat(Visitor *v, const char *name, GuestNetworkInterfaceStat **obj, Error **errp);
bool visit_type_GuestIpAddressList(Visitor *v, const char *name, GuestIpAddressList **obj, Error **errp);

bool visit_type_GuestNetworkInterface_members(Visitor *v, GuestNetworkInterface *obj, Error **errp);
bool visit_type_GuestNetworkInterface(Visitor *v, const char *name, GuestNetworkInterface **obj, Error **errp);
bool visit_type_GuestNetworkInterfaceList(Visitor *v, const char *name, GuestNetworkInterfaceList **obj, Error **errp);

bool visit_type_GuestLogicalProcessor_members(Visitor *v, GuestLogicalProcessor *obj, Error **errp);
bool visit_type_GuestLogicalProcessor(Visitor *v, const char *name, GuestLogicalProcessor **obj, Error **errp);
bool visit_type_GuestLogicalProcessorList(Visitor *v, const char *name, GuestLogicalProcessorList **obj, Error **errp);

bool visit_type_q_obj_guest_set_vcpus_arg_members(Visitor *v, q_obj_guest_set_vcpus_arg *obj, Error **errp);
bool visit_type_GuestDiskBusType(Visitor *v, const char *name, GuestDiskBusType *obj, Error **errp);

bool visit_type_GuestPCIAddress_members(Visitor *v, GuestPCIAddress *obj, Error **errp);
bool visit_type_GuestPCIAddress(Visitor *v, const char *name, GuestPCIAddress **obj, Error **errp);

bool visit_type_GuestDiskAddress_members(Visitor *v, GuestDiskAddress *obj, Error **errp);
bool visit_type_GuestDiskAddress(Visitor *v, const char *name, GuestDiskAddress **obj, Error **errp);
bool visit_type_GuestDiskAddressList(Visitor *v, const char *name, GuestDiskAddressList **obj, Error **errp);

bool visit_type_GuestFilesystemInfo_members(Visitor *v, GuestFilesystemInfo *obj, Error **errp);
bool visit_type_GuestFilesystemInfo(Visitor *v, const char *name, GuestFilesystemInfo **obj, Error **errp);
bool visit_type_GuestFilesystemInfoList(Visitor *v, const char *name, GuestFilesystemInfoList **obj, Error **errp);
...
bool visit_type_GuestMemoryBlock(Visitor *v, const char *name, GuestMemoryBlock **obj, Error **errp);
bool visit_type_GuestMemoryBlockList(Visitor *v, const char *name, GuestMemoryBlockList **obj, Error **errp);
bool visit_type_GuestMemoryBlockResponseType(Visitor *v, const char *name, GuestMemoryBlockResponseType *obj, Error **errp);

bool visit_type_GuestMemoryBlockResponse_members(Visitor *v, GuestMemoryBlockResponse *obj, Error **errp);
bool visit_type_GuestMemoryBlockResponse(Visitor *v, const char *name, GuestMemoryBlockResponse **obj, Error **errp);

bool visit_type_q_obj_guest_set_memory_blocks_arg_members(Visitor *v, q_obj_guest_set_memory_blocks_arg *obj, Error **errp);
bool visit_type_GuestMemoryBlockResponseList(Visitor *v, const char *name, GuestMemoryBlockResponseList **obj, Error **errp);

bool visit_type_GuestMemoryBlockInfo_members(Visitor *v, GuestMemoryBlockInfo *obj, Error **errp);
bool visit_type_GuestMemoryBlockInfo(Visitor *v, const char *name, GuestMemoryBlockInfo **obj, Error **errp);

bool visit_type_GuestExecStatus_members(Visitor *v, GuestExecStatus *obj, Error **errp);
bool visit_type_GuestExecStatus(Visitor *v, const char *name, GuestExecStatus **obj, Error **errp);
...
bool visit_type_GuestExec(Visitor *v, const char *name, GuestExec **obj, Error **errp);
...
bool visit_type_GuestHostName(Visitor *v, const char *name, GuestHostName **obj, Error **errp);

bool visit_type_GuestUser_members(Visitor *v, GuestUser *obj, Error **errp);
bool visit_type_GuestUser(Visitor *v, const char *name, GuestUser **obj, Error **errp);
bool visit_type_GuestUserList(Visitor *v, const char *name, GuestUserList **obj, Error **errp);

bool visit_type_GuestTimezone_members(Visitor *v, GuestTimezone *obj, Error **errp);
bool visit_type_GuestTimezone(Visitor *v, const char *name, GuestTimezone **obj, Error **errp);

bool visit_type_GuestOSInfo_members(Visitor *v, GuestOSInfo *obj, Error **errp);
bool visit_type_GuestOSInfo(Visitor *v, const char *name, GuestOSInfo **obj, Error **errp);
