...
bool visit_type_strList(Visitor *v, const char *name, strList **obj, Error **errp)
{
    bool ok = false;
    strList *tail;
...
bool visit_type_numberList(Visitor *v, const char *name, numberList **obj, Error **errp)
{
    bool ok = false;
    numberList *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_intList(Visitor *v, const char *name, intList **obj, Error **errp)
{
    bool ok = false;
    intList *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_int8List(Visitor *v, const char *name, int8List **obj, Error **errp)
{
    bool ok = false;
    int8List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_int16List(Visitor *v, const char *name, int16List **obj, Error **errp)
{
    bool ok = false;
    int16List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_int32List(Visitor *v, const char *name, int32List **obj, Error **errp)
{
    bool ok = false;
    int32List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_int64List(Visitor *v, const char *name, int64List **obj, Error **errp)
{
    bool ok = false;
    int64List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_uint8List(Visitor *v, const char *name, uint8List **obj, Error **errp)
{
    bool ok = false;
    uint8List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_uint16List(Visitor *v, const char *name, uint16List **obj, Error **errp)
{
    bool ok = false;
    uint16List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_uint32List(Visitor *v, const char *name, uint32List **obj, Error **errp)
{
    bool ok = false;
    uint32List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_uint64List(Visitor *v, const char *name, uint64List **obj, Error **errp)
{
    bool ok = false;
    uint64List *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_sizeList(Visitor *v, const char *name, sizeList **obj, Error **errp)
{
    bool ok = false;
    sizeList *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_boolList(Visitor *v, const char *name, boolList **obj, Error **errp)
{
    bool ok = false;
    boolList *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_anyList(Visitor *v, const char *name, anyList **obj, Error **errp)
{
    bool ok = false;
    anyList *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_nullList(Visitor *v, const char *name, nullList **obj, Error **errp)
{
    bool ok = false;
    nullList *tail;
    size_t size = sizeof(**obj);
...
bool visit_type_QType(Visitor *v, const char *name, QType *obj, Error **errp)
{
    int value = *obj;
