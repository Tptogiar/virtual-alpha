...
bool visit_type_RunState(Visitor *v, const char *name, RunState *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_ShutdownCause(Visitor *v, const char *name, ShutdownCause *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_StatusInfo(Visitor *v, const char *name, StatusInfo **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_WatchdogAction(Visitor *v, const char *name, WatchdogAction *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_GuestPanicAction(Visitor *v, const char *name, GuestPanicAction *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_GuestPanicInformationType(Visitor *v, const char *name, GuestPanicInformationType *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_GuestPanicInformation(Visitor *v, const char *name, GuestPanicInformation **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_GuestPanicInformationHyperV(Visitor *v, const char *name, GuestPanicInformationHyperV **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_S390CrashReason(Visitor *v, const char *name, S390CrashReason *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_GuestPanicInformationS390(Visitor *v, const char *name, GuestPanicInformationS390 **obj, Error **errp)
{
    bool ok = false;
