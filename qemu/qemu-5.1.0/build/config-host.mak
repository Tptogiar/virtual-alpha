...
VERSION=5.1.0
PKGVERSION=
SRC_PATH=/myFiles/virtual-alpha/qemu/qemu-5.1.0
...
EFI_AARCH64=/myFiles/virtual-alpha/qemu/qemu-5.1.0/build/pc-bios/edk2-aarch64-code.fd
PYTHON_YAML=yes
CC=ccache gcc
HOST_CC=cc
CXX=ccache g++
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg/i386 -isystem $(SRC_PATH)/linux-headers -isystem /myFiles/virtual-alpha/qemu/qemu-5.1.0/build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include -iquote $(SRC_PATH)/disas/libvixl
