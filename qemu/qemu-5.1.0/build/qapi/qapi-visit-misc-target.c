...
bool visit_type_SevState(Visitor *v, const char *name, SevState *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_SevInfo(Visitor *v, const char *name, SevInfo **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_SevLaunchMeasureInfo(Visitor *v, const char *name, SevLaunchMeasureInfo **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_SevCapability(Visitor *v, const char *name, SevCapability **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_GICCapability(Visitor *v, const char *name, GICCapability **obj, Error **errp)
{
    bool ok = false;
...
#if defined(TARGET_ARM)
bool visit_type_GICCapabilityList(Visitor *v, const char *name, GICCapabilityList **obj, Error **errp)
{
    bool ok = false;
