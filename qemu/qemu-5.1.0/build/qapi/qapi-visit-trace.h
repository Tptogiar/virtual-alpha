...
bool visit_type_TraceEventState(Visitor *v, const char *name, TraceEventState *obj, Error **errp);

bool visit_type_TraceEventInfo_members(Visitor *v, TraceEventInfo *obj, Error **errp);
bool visit_type_TraceEventInfo(Visitor *v, const char *name, TraceEventInfo **obj, Error **errp);

bool visit_type_q_obj_trace_event_get_state_arg_members(Visitor *v, q_obj_trace_event_get_state_arg *obj, Error **errp);
bool visit_type_TraceEventInfoList(Visitor *v, const char *name, TraceEventInfoList **obj, Error **errp);
