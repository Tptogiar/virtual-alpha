...
bool visit_type_BiosAtaTranslation(Visitor *v, const char *name, BiosAtaTranslation *obj, Error **errp);
bool visit_type_FloppyDriveType(Visitor *v, const char *name, FloppyDriveType *obj, Error **errp);

bool visit_type_PRManagerInfo_members(Visitor *v, PRManagerInfo *obj, Error **errp);
bool visit_type_PRManagerInfo(Visitor *v, const char *name, PRManagerInfo **obj, Error **errp);
bool visit_type_PRManagerInfoList(Visitor *v, const char *name, PRManagerInfoList **obj, Error **errp);
...
bool visit_type_BlockdevChangeReadOnlyMode(Visitor *v, const char *name, BlockdevChangeReadOnlyMode *obj, Error **errp);
