...
bool visit_type_JobType(Visitor *v, const char *name, JobType *obj, Error **errp);
bool visit_type_JobStatus(Visitor *v, const char *name, JobStatus *obj, Error **errp);
bool visit_type_JobVerb(Visitor *v, const char *name, JobVerb *obj, Error **errp);
...
bool visit_type_JobInfo(Visitor *v, const char *name, JobInfo **obj, Error **errp);
bool visit_type_JobInfoList(Visitor *v, const char *name, JobInfoList **obj, Error **errp);
