...
bool visit_type_QAuthZListPolicy(Visitor *v, const char *name, QAuthZListPolicy *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_QAuthZListFormat(Visitor *v, const char *name, QAuthZListFormat *obj, Error **errp)
{
    int value = *obj;
...
bool visit_type_QAuthZListRule(Visitor *v, const char *name, QAuthZListRule **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_QAuthZListRuleList(Visitor *v, const char *name, QAuthZListRuleList **obj, Error **errp)
{
    bool ok = false;
...
bool visit_type_QAuthZListRuleListHack(Visitor *v, const char *name, QAuthZListRuleListHack **obj, Error **errp)
{
    bool ok = false;
